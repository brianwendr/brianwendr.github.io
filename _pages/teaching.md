...
<div class="teaching-list">
  ...
  <section class="teaching-course">
    ...
    <p>
      This course introduces core marketing-management concepts, connecting consumer behavior,
      competitive analysis, segmentation, marketing research, communication strategy, service
      marketing, brand management, pricing, and distribution decisions.
    </p>

    <div class="course-meta">
      <div>
        <strong>Assessment</strong>
        <span>Final exam 30%, case report 30%, class participation 10%, group presentation 30%</span>
      </div>
      <div>
        <strong>Primary text</strong>
        <span>Kotler &amp; Armstrong, <em>Principles of Marketing</em>, 17th ed., Pearson, 2018</span>
      </div>
    </div>

    <h3>Weekly Topics</h3>
    <ol class="course-schedule">
      <li>Structure &amp; Introduction to Marketing</li>
      <li>The New Economy and Its Implications for Marketing</li>
      <li>Corporate Strategy and Marketing Alignment</li>
      <li>Analyzing Consumer Behavior</li>
      <li>Analyzing Competitors</li>
      <li>Market Segmentation, Targeting, and Positioning</li>
      <li>Marketing Research Methodologies</li>
      <li>Midterm Examination/Report</li>
      <li>Midterm Project Presentation</li>
      <li>Marketing Communication Strategies</li>
      <li>Service Marketing and Brand Management Strategies</li>
      <li>Guest Lecture/Case Study Analysis</li>
